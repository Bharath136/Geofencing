...
//     return (
//         <View style={tw`p-4`}>
//             <View style={tw`flex-row items-center bg-gray-200 rounded px-4`}>
//                 <TextInput
...
//                     <Ionicons name="mic" size={20} style={tw`ml-2`} />  {/* Mic icon at the end */}
//                 </TouchableOpacity>
//             </View>
//         </View>
//     );
...
export default function SearchBar() {
    ...
    return (
        <View style={tw`p-4`}>
            <View style={tw`flex-row items-center bg-gray-200 rounded px-4 py-2`}>
                <TextInput
                    style={tw`flex-1 text-gray-500`} // Takes up remaining space for search input
                    placeholder="Search..."
                    value={searchText}
